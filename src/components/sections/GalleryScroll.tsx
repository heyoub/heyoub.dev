...
export function GalleryScroll() {
  ...
  return (
    ...
    >
      ...
      <div
        className="sticky top-20 z-0 pointer-events-none"
        style={{ paddingTop: fluidLayout.sectionPy, paddingBottom: fluidLayout.sectionPy }}
      >
              ...
              return (
                ...
                >
                  <div className="flex items-center gap-3 mb-2">
                    ...
                    />
                    <span
                      className="font-mono tracking-wider uppercase text-accent"
                      style={{ fontSize: fluidType.monoXs }}
                    >
                      {principle.label}
                    </span>
                  </div>
                  ...
                  <p
                    className="text-text-secondary mb-2 pl-4 border-l border-white/10 group-hover:border-accent/30 transition-colors"
                    style={{ fontSize: fluidType.detailSm }}
                  >
                    {principle.title} — <span className="text-text-muted">{principle.summary}</span>
                  </p>

                  <p
                    className="text-text-primary pl-4 font-light"
                    style={{ fontSize: fluidType.detailBase }}
                  >
                    &rarr; {point.proof}
                    {point.link && (
                      <a
                        ...
                        className="ml-2 text-accent/70 hover:text-accent font-mono transition-colors"
                        style={{ fontSize: fluidType.monoXs }}
                      >
                        [{point.link.label}]
                      </a>
    ...
    >
      ...
      >
        <h3
          ...
          style={{
            fontSize: fluidType.parallaxText,
