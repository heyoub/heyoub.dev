    ...
    >
      ...
      >
        <div className="flex gap-0 overflow-x-auto scrollbar-hide">
          {/* Contact tab — first */}
          <button
            className={`font-mono text-xs px-4 py-2 flex items-center gap-2 whitespace-nowrap transition-colors ${activeTab === 'contact'
          ...
          {/* the/FBF tab */}
          <button
            className={`font-mono text-xs px-4 py-2 flex items-center gap-2 whitespace-nowrap transition-colors ${activeTab === 'fbf'
              ? 'text-text-primary bg-editor-bg border-b-2 border-accent'
              : 'text-text-muted bg-editor-chrome hover:text-text-secondary hover:bg-editor-bg/50'
              }`}
          ...
          {projectManifest.map((project) => (
            <button
              ...
              className={`font-mono text-xs px-4 py-2 flex items-center gap-2 whitespace-nowrap transition-colors ${activeTab === project.pitch.filename
                ? 'text-text-primary bg-editor-bg border-b-2 border-accent'
                : 'text-text-muted bg-editor-chrome hover:text-text-secondary hover:bg-editor-bg/50'
                }`}
        ...
        <div className="flex gap-2 shrink-0 ml-4" aria-hidden="true">
          <span className="w-3 h-3 rounded-full bg-editor-red" />
          <span className="w-3 h-3 rounded-full bg-editor-yellow" />
          <span className="w-3 h-3 rounded-full bg-editor-green" />
        </div>
      </div>
      ...
      <div className="flex-1 relative overflow-auto">
        ...
        >
          <div className="flex flex-col items-end font-mono text-xs text-editor-gray leading-relaxed">
      ...
      >
        <div className="flex items-center gap-3 text-editor-gray-light">
          <span
        ...
        <small className="font-mono text-[0.65rem] tracking-wider text-editor-gray">
